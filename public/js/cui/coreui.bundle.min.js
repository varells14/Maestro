...
!(function (t, e) {
    ...
    class st extends H {
        ...
        _initEvents() {
            this._supportPointerEvents
                ? (I.on(this._element, tt, (t) => this._start(t)),
                  I.on(this._element, et, (t) => this._end(t)),
                  this._element.classList.add("pointer-event"))
                : (I.on(this._element, G, (t) => this._start(t)),
    ...
    class Lt extends B {
        ...
        _maybeEnableCycle() {
            this._config.ride &&
                (this._isSliding
                    ? I.one(this._element, pt, () => this.cycle())
                    : this.cycle());
        }
        to(t) {
            ...
            if (this._isSliding)
                return void I.one(this._element, pt, () => this.to(t));
        ...
        _addEventListeners() {
            this._config.keyboard &&
                I.on(this._element, gt, (t) => this._keydown(t)),
                "hover" === this._config.pause &&
                    (I.on(this._element, mt, () => this.pause()),
                    I.on(this._element, _t, () => this._maybeEnableCycle())),
                this._config.touch &&
                    st.isSupported() &&
    ...
    I.on(
        ...
        g(Lt);
    const St = ".coreui.collapse",
        Dt = `show${St}`,
        $t = `shown${St}`,
        Nt = `hide${St}`,
        It = `hidden${St}`,
        Mt = `click${St}.data-api`,
        Pt = "show",
        jt = "collapse",
        Ft = "collapsing",
        Ht = `:scope .${jt} .${jt}`,
    ...
    class qt extends B {
            ...
            this._queueCallback(
                () => {
                    (this._isTransitioning = !1),
                        ...
                        this._element.classList.add(jt, Pt),
        ...
        hide() {
            ...
            (this._element.style[t] = `${
                ...
                d(this._element),
                this._element.classList.add(Ft),
                this._element.classList.remove(jt, Pt);
    ...
    function ze(t) {
        ...
        var T,
            O = Object.assign({ position: a }, c && We),
            k =
                !0 === h
                    ? (function (t, e) {
                          var i = t.x,
                ...
                if (A) {
                    if (o) {
                        var L,
                            ...
                            R = Pe(0, E[$], B[$]),
                            V = v
                                ? E[$] / 2 - P - R - z - O.mainAxis
                                : j - R - z - O.mainAxis,
                            U = v
                                ? -E[$] / 2 + P + R + q + O.mainAxis
                                : F + R + q + O.mainAxis,
    ...
    var bi = _i(),
        vi = _i({ defaultModifiers: [Ve, di, qe, ve] }),
        yi = _i({ defaultModifiers: [Ve, di, qe, ve, hi, ri, ui, He, ci] });
    ...
    class Ui extends B {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    z.next(this._element, ji)[0] ||
                    z.prev(this._element, ji)[0] ||
                    z.findOne(ji, this._parent)),
        ...
        static dataApiKeydownHandler(t) {
            ...
            const s = this.matches(Mi)
                    ...
                    : z.prev(this, Mi)[0] ||
                      z.next(this, Mi)[0] ||
                      z.findOne(Mi, t.delegateTarget.parentNode),
    ...
    I.on(document, $i, Mi, Ui.dataApiKeydownHandler),
        I.on(document, $i, ji, Ui.dataApiKeydownHandler),
        I.on(document, Di, Ui.clearMenus),
        I.on(document, Ni, Ui.clearMenus),
        I.on(document, Di, Mi, function (t) {
            t.preventDefault(), Ui.getOrCreateInstance(this).toggle();
        }),
        g(Ui);
    const Ki = "backdrop",
        Qi = "show",
        Yi = `mousedown.coreui.${Ki}`,
        Xi = {
    ...
    class rn extends H {
        ...
        activate() {
            this._isActive ||
                ...
                I.off(document, Zi),
                I.on(document, tn, (t) => this._handleFocusin(t)),
                I.on(document, en, (t) => this._handleKeydown(t)),
                (this._isActive = !0));
        }
        deactivate() {
    ...
    class xn extends B {
        ...
        show(t) {
            this._isShown ||
                ...
                I.trigger(this._element, mn, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
        ...
        hide() {
            this._isShown &&
                !this._isTransitioning &&
                (I.trigger(this._element, fn).defaultPrevented ||
                    ((this._isShown = !1),
                    (this._isTransitioning = !0),
                ...
                this._queueCallback(
                    () => {
                        this._config.focus && this._focustrap.activate(),
                            (this._isTransitioning = !1),
                            I.trigger(this._element, _n, { relatedTarget: t });
                    },
                    this._dialog,
                    this._isAnimated()
                );
        ...
        _addEventListeners() {
            I.on(this._element, wn, (t) => {
                ...
                I.on(this._element, yn, (t) => {
                    I.one(this._element, vn, (e) => {
    ...
    I.on(document, An, '[data-coreui-toggle="modal"]', function (t) {
        ...
        q(xn),
        g(xn);
    const Ln = "coreui.navigation",
        Sn = `.${Ln}`,
        Dn = ".data-api",
        $n = { activeLinksExact: !0, groupsAutoCollapse: !0 },
        Nn = {
    ...
    class zn extends B {
        ...
        _setActiveLink() {
            for (const t of Array.from(
                ...
                if (t.classList.contains(Pn)) continue;
                ...
                (/\?.*=/.test(e) || i.test(e)) && (e = e.split("?")[0]),
                    ...
                    this._config.activeLinksExact &&
                        t.href === e &&
                        (t.classList.add(In),
                        Array.from(this._getParents(t, Hn)).forEach((t) => {
                            t.classList.add(Mn),
            ...
            const i = (t) =>
                Boolean(
                    t.classList.contains("nav-group") &&
                        t.classList.contains(Mn)
                );
            if (!0 === this._config.groupsAutoCollapse)
                for (const t of this._getSiblings(e.parentNode, i))
                    this._slideUp(z.findOne(Bn, t), () => {
                        t.classList.remove(Mn),
                            t.setAttribute("aria-expanded", !1);
                    });
            e.parentNode.classList.contains(Mn)
                ? this._slideUp(z.findOne(Bn, e.parentNode), () => {
                      e.parentNode.classList.remove(Mn),
                          e.parentNode.setAttribute("aria-expanded", !1);
                  })
                : (e.parentNode.classList.add(Mn),
                  e.parentNode.setAttribute("aria-expanded", !0),
                  this._slideDown(z.findOne(Bn, e.parentNode)));
        }
        _addEventListeners() {
            I.on(this._element, jn, Wn, (t) => {
                t.preventDefault(), this._toggleGroupItems(t, this);
            });
        }
        static navigationInterface(t, e) {
            const i = zn.getOrCreateInstance(t, e);
            if ("string" == typeof e) {
                if (void 0 === i[e])
    ...
    I.on(window, Fn, () => {
        for (const t of Array.from(
            ...
            zn.navigationInterface(t);
    }),
        g(zn);
    const qn = ".coreui.offcanvas",
        Rn = ".data-api",
        Vn = `load${qn}${Rn}`,
        Un = "show",
        Kn = "showing",
        ...
        es = `resize${qn}`,
        is = `click${qn}${Rn}`,
        ns = `keydown.dismiss${qn}`,
        ss = { backdrop: !0, keyboard: !0, scroll: !1 },
        os = {
            backdrop: "(boolean|string)",
            keyboard: "boolean",
            scroll: "boolean",
    ...
    class rs extends B {
        ...
        show(t) {
            this._isShown ||
                I.trigger(this._element, Xn, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                this._backdrop.show(),
                ...
                this._queueCallback(
                    () => {
                        (this._config.scroll && !this._config.backdrop) ||
                            ...
                            I.trigger(this._element, Gn, { relatedTarget: t });
                    },
                    this._element,
                    !0
                ));
        ...
        hide() {
            this._isShown &&
                (I.trigger(this._element, Jn).defaultPrevented ||
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
                    ...
                    this._queueCallback(
                        () => {
                            this._element.classList.remove(Un, Qn),
                                this._element.removeAttribute("aria-modal"),
                                this._element.removeAttribute("role"),
                                this._config.scroll || new dn().reset(),
                                I.trigger(this._element, ts);
                        },
                        this._element,
                        !0
                    )));
    ...
    I.on(document, is, '[data-coreui-toggle="offcanvas"]', function (t) {
        ...
        const i = z.findOne(Yn);
        i && i !== e && rs.getInstance(i).hide(),
            rs.getOrCreateInstance(e).toggle(this);
    }),
        I.on(window, Vn, () => {
            for (const t of z.find(Yn)) rs.getOrCreateInstance(t).show();
        }),
        I.on(window, es, () => {
    ...
    const as = {
        ...
        hs = (t, e) => {
            ...
            return e.includes(i)
                ? !ls.has(i) || Boolean(cs.test(t.nodeValue))
    ...
    class ps extends H {
        ...
        _checkContent(t) {
            for (const [e, i] of Object.entries(t))
                super._typeCheckConfig({ selector: e, entry: i }, fs);
        }
        _setContent(t, e, i) {
                ...
                ? (function (t, e, i) {
                      ...
                      for (const t of s) {
                          ...
                          const n = [].concat(...t.attributes),
                              s = [].concat(e["*"] || [], e[i] || []);
                          for (const e of n)
                              hs(e, s) || t.removeAttribute(e.nodeName);
                      }
    ...
    class Os extends B {
        ...
        dispose() {
            clearTimeout(this._timeout),
                I.off(this._element.closest(vs), ys, this._hideModalHandler),
        ...
        hide() {
            if (
                ...
                if (
                    (this._getTipElement().classList.remove(_s),
                    "ontouchstart" in document.documentElement)
                )
                    for (const t of [].concat(...document.body.children))
                        I.off(t, "mouseover", h);
        ...
        _createTipElement(t) {
            ...
            return (
                e.setAttribute("id", i),
                this._isAnimated() && e.classList.add(ms),
                e
            );
        }
        setContent(t) {
        ...
        _isAnimated() {
            return (
                ...
                (this.tip && this.tip.classList.contains(ms))
            );
        }
        _isShown() {
            ...
            for (const e of t)
                if ("click" === e)
                    ...
                    I.on(this._element, t, this._config.selector, (t) => {
                        ...
                        (e._activeTrigger["focusin" === t.type ? As : ws] = !0),
                            e._enter();
                    }),
                        I.on(this._element, i, this._config.selector, (t) => {
                            const e = this._initializeOnDelegatedTarget(t);
                            (e._activeTrigger["focusout" === t.type ? As : ws] =
        ...
        _getConfig(t) {
            ...
            for (const t of Object.keys(e)) gs.has(t) && delete e[t];
            return (
    ...
    const ks = ".popover-header",
        ...
        Ss = { ...Os.DefaultType, content: "(null|string|element|function)" };
    class Ds extends Os {
        static get Default() {
            return Ls;
        }
        ...
        _getContentForTemplate() {
            return { [ks]: this._getTitle(), [xs]: this._getContent() };
        }
        _getContent() {
    ...
    const $s = ".coreui.scrollspy",
        ...
        js = "[href]",
        Fs = ".nav-link",
        Hs = `${Fs}, .nav-item > ${Fs}, .list-group-item`,
        Bs = {
            offset: null,
    ...
    class zs extends B {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll &&
                (I.off(this._config.target, Is),
                I.on(this._config.target, Is, js, (t) => {
        ...
        _initializeTargetsAndObservables() {
            (this._targetLinks = new Map()),
                (this._observableSections = new Map());
            const t = z.find(js, this._config.target);
            for (const e of t) {
        ...
        _process(t) {
            this._activeTarget !== t &&
                ...
                I.trigger(this._element, Ns, { relatedTarget: t }));
        }
        _activateParents(t) {
            if (t.classList.contains("dropdown-item"))
                ...
                for (const e of z.parents(t, ".nav, .list-group"))
                    for (const t of z.prev(e, Hs)) t.classList.add(Ps);
        }
        _clearActiveClass(t) {
            t.classList.remove(Ps);
            const e = z.find(`${js}.${Ps}`, t);
    ...
    class so extends B {
        ...
        hide() {
            I.trigger(this._element, Gs),
                this._element.classList.contains(Qs) &&
                    this._element.classList.remove(Qs),
                this._isMobile() && (this._backdrop.hide(), new dn().reset()),
                this._isMobile() ||
                    this._overlaid ||
        ...
        unfoldable() {
            this._isMobile() ||
                (this._addClassName(Xs), (this._unfoldable = !0));
        }
        reset() {
            this._isMobile() ||
                (this._narrow &&
                    (this._element.classList.remove(Ys), (this._narrow = !1)),
                this._unfoldable &&
        ...
        _addEventListeners() {
            this._mobile && this._show && this._addClickOutListener(),
                ...
                I.on(this._element, eo, "[data-coreui-toggle]", (t) => {
                    t.preventDefault();
        ...
        static sidebarInterface(t, e) {
            const i = so.getOrCreateInstance(t, e);
            if ("string" == typeof e) {
                if (void 0 === i[e])
                    throw new TypeError(`No method named "${e}"`);
                i[e]();
    ...
    I.on(window, io, () => {
        for (const t of Array.from(document.querySelectorAll(no)))
            so.sidebarInterface(t);
    }),
        g(so);
    const oo = ".coreui.tab",
        ro = `hide${oo}`,
        ...
        Oo = `.nav-link${Co}, .list-group-item${Co}, [role="tab"]${Co}, ${To}`,
        ko = `.${yo}[data-coreui-toggle="tab"], .${yo}[data-coreui-toggle="pill"], .${yo}[data-coreui-toggle="list"]`;
    class xo extends B {
        constructor(t) {
            super(t),
                ...
                this._parent &&
                    ...
                    I.on(this._element, uo, (t) => this._keydown(t)));
        }
        static get NAME() {
            return "tab";
        }
        show() {
            ...
            const e = this._getActiveElem(),
                i = e ? I.trigger(e, ro, { relatedTarget: t }) : null;
            I.trigger(t, lo, { relatedTarget: e }).defaultPrevented ||
                    ...
                    () => {
                        "tab" === t.getAttribute("role")
                            ? (t.removeAttribute("tabindex"),
                              ...
                              I.trigger(t, co, { relatedTarget: e }))
                            : t.classList.add(Ao);
                    },
                    t,
                    t.classList.contains(wo)
                ));
        }
        _deactivate(t, e) {
            t &&
                    ...
                    () => {
                        "tab" === t.getAttribute("role")
                            ? (t.setAttribute("aria-selected", !1),
                              ...
                              I.trigger(t, ao, { relatedTarget: e }))
        ...
        _keydown(t) {
            ...
            let i;
            if ([bo, vo].includes(t.key))
                i = e[t.key === bo ? 0 : e.length - 1];
            else {
                const n = [go, _o].includes(t.key);
                i = b(e, t.target, n, !0);
            }
            i &&
        ...
        static jQueryInterface(t) {
            return this.each(function () {
                const e = xo.getOrCreateInstance(this);
                if ("string" == typeof t) {
                    if (
                        void 0 === e[t] ||
                        t.startsWith("_") ||
    ...
    I.on(document, ho, To, function (t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            l(this) || xo.getOrCreateInstance(this).show();
    }),
        I.on(window, fo, () => {
            for (const t of z.find(ko)) xo.getOrCreateInstance(t);
        }),
        g(xo);
    const Lo = ".coreui.toast",
        So = `mouseover${Lo}`,
        Do = `mouseout${Lo}`,
        $o = `focusin${Lo}`,
        No = `focusout${Lo}`,
        ...
        zo = { animation: !0, autohide: !0, delay: 5e3 };
    class qo extends B {
        constructor(t, e) {
            super(t, e),
                (this._timeout = null),
        ...
        show() {
            I.trigger(this._element, Po).defaultPrevented ||
                (this._clearTimeout(),
                this._config.animation && this._element.classList.add("fade"),
                this._element.classList.remove(Fo),
                d(this._element),
                this._element.classList.add(Ho, Bo),
                this._queueCallback(
                    () => {
                        this._element.classList.remove(Bo),
                            I.trigger(this._element, jo),
        ...
        hide() {
            this.isShown() &&
                (I.trigger(this._element, Io).defaultPrevented ||
                    (this._element.classList.add(Bo),
                    this._queueCallback(
                        () => {
                            this._element.classList.add(Fo),
                                this._element.classList.remove(Bo, Ho),
                                I.trigger(this._element, Mo);
                        },
                        this._element,
                        this._config.animation
                    )));
        ...
        _setListeners() {
            I.on(this._element, So, (t) => this._onInteraction(t, !0)),
                I.on(this._element, Do, (t) => this._onInteraction(t, !1)),
                I.on(this._element, $o, (t) => this._onInteraction(t, !0)),
                I.on(this._element, No, (t) => this._onInteraction(t, !1));
        }
        _clearTimeout() {
